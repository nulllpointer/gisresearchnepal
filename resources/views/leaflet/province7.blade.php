...
--}}
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="map" style="height: 560px; background-color: #2ab27b">
...
//from geojson file
        ...
        var layerGroup = L.geoJSON(province7, {
            onEachFeature: function (feature, layer) {
                layer.bindPopup('<h1>'+feature.properties.DISTRICT+'</h1><p>name: '+feature.properties.HQ+'</p>');
            }
        }).addTo(mymap);
