...
<script src="../../../geojson/sadarmukam" type="text/javascript"></script>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="map" style="height: 470px; background-color: #2ab27b">
...
@section('page-script')
    ...
    <script>
        ...
        L.geoJson(devregion).addTo(mymap);


        L.geoJson(sadarmukam).addTo(mymap).bindPopup(function (layer) {
            return layer.feature.properties.HQ_NAME;
